...
[TestClass]
public class ConvenientBlockTest
{
    [TestMethod]
    public void Example0()
    {
        ...
        long __result = new ConvenientBlock().minCost(N, from, to, cost);
